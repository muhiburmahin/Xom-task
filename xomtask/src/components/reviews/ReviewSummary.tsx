...
function HonestReviewsTooltip() {
  return (
    <div className="w-[340px] max-w-[calc(100vw-3rem)] rounded-[20px] bg-white px-5 py-4 shadow-[0_8px_24px_rgba(16,24,40,0.12)] sm:w-[360px] sm:px-6 sm:py-5">
      ...
      <ol className="mt-4 list-none space-y-3 p-0 pl-12 sm:pl-14">
